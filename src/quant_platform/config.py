...
DEFAULT_LYNCH_DRY_RUN_CSV = DRY_RUN_OUTPUT_DIR / "lynch_scan_results.csv"
DEFAULT_LYNCH_DRY_RUN_JSON = DRY_RUN_OUTPUT_DIR / "lynch_scan_report.json"
DEFAULT_LYNCH_DRY_RUN_MD = DRY_RUN_OUTPUT_DIR / "lynch_scan_summary.md"
